...
int main(void)
{
  ...
  17:	68 e8 07 00 00       	push   $0x7e8
  1c:	68 f6 07 00 00       	push   $0x7f6
  21:	6a 01                	push   $0x1
  23:	e8 98 04 00 00       	call   4c0 <printf>
...
int cid = fork();
  ...
  37:	6a 08                	push   $0x8
  39:	e8 b2 06 00 00       	call   6f0 <malloc>
  ...
  59:	50                   	push   %eax
  5a:	53                   	push   %ebx
  5b:	68 fa 07 00 00       	push   $0x7fa
  60:	6a 01                	push   $0x1
  62:	e8 59 04 00 00       	call   4c0 <printf>
		exit();
  ...
  71:	6a 08                	push   $0x8
  73:	e8 78 06 00 00       	call   6f0 <malloc>
		msg_child = "P";
		printf(1,"1 PARENT: msg sent is: %s \n", msg_child );
  78:	83 c4 0c             	add    $0xc,%esp
  7b:	68 15 08 00 00       	push   $0x815
  ...
  9b:	e8 33 03 00 00       	call   3d3 <send>
		...
		free(msg_child);
  a0:	c7 04 24 15 08 00 00 	movl   $0x815,(%esp)
  a7:	e8 b4 05 00 00       	call   660 <free>
	}
	wait();
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 449:	0f b6 92 94 08 00 00 	movzbl 0x894(%edx),%edx
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 539:	ff 24 85 3c 08 00 00 	jmp    *0x83c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba 33 08 00 00       	mov    $0x833,%edx
        while(*s != 0){
 ...
 661:	a1 40 0b 00 00       	mov    0xb40,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 40 0b 00 00    	mov    %edx,0xb40
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 40 0b 00 00    	mov    %edx,0xb40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d 40 0b 00 00    	mov    0xb40,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 4f                	jae    790 <malloc+0xa0>
    ...
    if(p == freep)
 741:	8b 3d 40 0b 00 00    	mov    0xb40,%edi
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 40 0b 00 00    	mov    0xb40,%edx
