...
int main(int argc, char *argv[])
{
  ...
  11:	6a 03                	push   $0x3
  13:	6a 02                	push   $0x2
  15:	e8 29 03 00 00       	call   343 <add>
  printf(1, "%d + %d = %d\n", a, b, result);
  1a:	89 04 24             	mov    %eax,(%esp)
  1d:	6a 03                	push   $0x3
  1f:	6a 02                	push   $0x2
  21:	68 68 07 00 00       	push   $0x768
  26:	6a 01                	push   $0x1
  28:	e8 13 04 00 00       	call   440 <printf>

  exit();
  2d:	83 c4 20             	add    $0x20,%esp
  30:	e8 5e 02 00 00       	call   293 <exit>
  35:	66 90                	xchg   %ax,%ax
  37:	66 90                	xchg   %ax,%ax
  39:	66 90                	xchg   %ax,%ax
  3b:	66 90                	xchg   %ax,%ax
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba 76 07 00 00       	mov    $0x776,%edx
        while(*s != 0){
