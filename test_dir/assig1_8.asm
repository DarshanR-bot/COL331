  ...
  14:	83 39 01             	cmpl   $0x1,(%ecx)
{
  17:	8b 41 04             	mov    0x4(%ecx),%eax
	if(argc< 2){
  1a:	7e 2d                	jle    49 <main+0x49>
		printf(1,"Need type and input filename\n");
		exit();
	}
	char *filename;
	filename=argv[2];
  1c:	8b 48 08             	mov    0x8(%eax),%ecx
	int type = atoi(argv[1]);
  1f:	83 ec 0c             	sub    $0xc,%esp
	filename=argv[2];
  22:	89 4d cc             	mov    %ecx,-0x34(%ebp)
	int type = atoi(argv[1]);
  25:	ff 70 04             	push   0x4(%eax)
  28:	e8 63 03 00 00       	call   390 <atoi>
  ...
  2d:	83 c4 10             	add    $0x10,%esp
	int type = atoi(argv[1]);
  30:	89 45 d0             	mov    %eax,-0x30(%ebp)
	short arr[size];
  33:	89 e0                	mov    %esp,%eax
  35:	39 c4                	cmp    %eax,%esp
  37:	74 23                	je     5c <main+0x5c>
  39:	81 ec 00 10 00 00    	sub    $0x1000,%esp
  3f:	83 8c 24 fc 0f 00 00 	orl    $0x0,0xffc(%esp)
  46:	00 
  47:	eb ec                	jmp    35 <main+0x35>
		printf(1,"Need type and input filename\n");
  49:	53                   	push   %ebx
  4a:	53                   	push   %ebx
  ...
  52:	e8 59 05 00 00       	call   5b0 <printf>
		exit();
  57:	e8 a7 03 00 00       	call   403 <exit>
	short arr[size];
  5c:	81 ec d0 07 00 00    	sub    $0x7d0,%esp
  62:	83 8c 24 cc 07 00 00 	orl    $0x0,0x7cc(%esp)
  69:	00 
  6a:	89 e3                	mov    %esp,%ebx
  6c:	8d 7d e3             	lea    -0x1d(%ebp),%edi
  6f:	89 5d c8             	mov    %ebx,-0x38(%ebp)
	char c;
  ...
  79:	e8 c5 03 00 00       	call   443 <open>
  7e:	89 dc                	mov    %ebx,%esp
  80:	89 c6                	mov    %eax,%esi
	for(int i=0; i<size; i++){
  82:	8d 83 d0 07 00 00    	lea    0x7d0(%ebx),%eax
  ...
  98:	57                   	push   %edi
  99:	56                   	push   %esi
  9a:	e8 7c 03 00 00       	call   41b <read>
		arr[i]=c-'0';
  9f:	66 0f be 45 e3       	movsbw -0x1d(%ebp),%ax
		read(fd, &c, 1);
  ...
  b0:	57                   	push   %edi
  b1:	56                   	push   %esi
  b2:	e8 64 03 00 00       	call   41b <read>
	for(int i=0; i<size; i++){
  ...
  c3:	31 f6                	xor    %esi,%esi
  	close(fd);
  c5:	e8 61 03 00 00       	call   42b <close>
	int coordinator=getpid();
  ca:	e8 b4 03 00 00       	call   483 <getpid>
  ...
  d4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
		cnum=i;
		cid[i]=fork();
  d8:	e8 1e 03 00 00       	call   3fb <fork>
		if(cid[i]!=0);//printf(1, "Init %d\n", cid[i]);
  dd:	89 f2                	mov    %esi,%edx
	for(int i=0; i<NUMPROCS; i++){
  df:	83 c6 01             	add    $0x1,%esi
		if(cid[i]!=0);//printf(1, "Init %d\n", cid[i]);
  e2:	85 c0                	test   %eax,%eax
  e4:	74 59                	je     13f <main+0x13f>
	for(int i=0; i<NUMPROCS; i++){
  e6:	83 fe 08             	cmp    $0x8,%esi
  e9:	75 ed                	jne    d8 <main+0xd8>
  eb:	bb 08 00 00 00       	mov    $0x8,%ebx
  f0:	31 f6                	xor    %esi,%esi
  f2:	8d 7d e4             	lea    -0x1c(%ebp),%edi
  ...
  fb:	57                   	push   %edi
  fc:	e8 ca 03 00 00       	call   4cb <recv>
			sum+=rec_partial;
 101:	03 75 e4             	add    -0x1c(%ebp),%esi
 ...
 104:	e8 02 03 00 00       	call   40b <wait>
 109:	e8 fd 02 00 00       	call   40b <wait>
 10e:	e8 f8 02 00 00       	call   40b <wait>
 113:	e8 f3 02 00 00       	call   40b <wait>
 118:	e8 ee 02 00 00       	call   40b <wait>
 11d:	e8 e9 02 00 00       	call   40b <wait>
 122:	e8 e4 02 00 00       	call   40b <wait>
 127:	e8 df 02 00 00       	call   40b <wait>
		for(int i=0;i<NUMPROCS; i++){
 12c:	83 c4 10             	add    $0x10,%esp
 12f:	83 eb 01             	sub    $0x1,%ebx
 132:	75 c4                	jne    f8 <main+0xf8>
		}
	}
 ...
 134:	83 7d d0 00          	cmpl   $0x0,-0x30(%ebp)
 138:	74 5b                	je     195 <main+0x195>
	...
	// }
	exit();
 13a:	e8 c4 02 00 00       	call   403 <exit>
		for(int i=cnum*size/NUMPROCS; i<(cnum+1)*size/NUMPROCS; i=i+1)partial+=arr[i];
 13f:	69 d2 e8 03 00 00    	imul   $0x3e8,%edx,%edx
		int partial=0;
 145:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
		for(int i=cnum*size/NUMPROCS; i<(cnum+1)*size/NUMPROCS; i=i+1)partial+=arr[i];
 14c:	89 d6                	mov    %edx,%esi
 14e:	81 c2 e8 03 00 00    	add    $0x3e8,%edx
 154:	c1 fe 03             	sar    $0x3,%esi
 157:	c1 fa 03             	sar    $0x3,%edx
 15a:	39 f2                	cmp    %esi,%edx
 15c:	7e 21                	jle    17f <main+0x17f>
 15e:	8b 4d c8             	mov    -0x38(%ebp),%ecx
 161:	01 f6                	add    %esi,%esi
 163:	01 d2                	add    %edx,%edx
 165:	01 ce                	add    %ecx,%esi
 167:	01 d1                	add    %edx,%ecx
 169:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 170:	0f bf 16             	movswl (%esi),%edx
 173:	83 c6 02             	add    $0x2,%esi
 176:	01 d0                	add    %edx,%eax
 178:	39 f1                	cmp    %esi,%ecx
 17a:	75 f4                	jne    170 <main+0x170>
 17c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
		send(getpid(), coordinator, &partial);
 17f:	e8 ff 02 00 00       	call   483 <getpid>
 184:	52                   	push   %edx
 185:	8d 55 e4             	lea    -0x1c(%ebp),%edx
 188:	52                   	push   %edx
 189:	53                   	push   %ebx
 18a:	50                   	push   %eax
 18b:	e8 33 03 00 00       	call   4c3 <send>
		exit();
 190:	e8 6e 02 00 00       	call   403 <exit>
		printf(1,"Sum of array for file %s is %d\n", filename,tot_sum);
 195:	56                   	push   %esi
 196:	ff 75 cc             	push   -0x34(%ebp)
 199:	68 f8 08 00 00       	push   $0x8f8
 19e:	6a 01                	push   $0x1
 1a0:	e8 0b 04 00 00       	call   5b0 <printf>
 1a5:	83 c4 10             	add    $0x10,%esp
 1a8:	eb 90                	jmp    13a <main+0x13a>
 ...
 50c:	89 d1                	mov    %edx,%ecx
{
 ...
 539:	0f b6 92 78 09 00 00 	movzbl 0x978(%edx),%edx
 ...
 5b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 629:	ff 24 85 20 09 00 00 	jmp    *0x920(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 737:	90                   	nop
          s = "(null)";
 738:	ba 18 09 00 00       	mov    $0x918,%edx
        while(*s != 0){
 ...
 751:	a1 2c 0c 00 00       	mov    0xc2c,%eax
{
 ...
 791:	5b                   	pop    %ebx
  freep = p;
 792:	89 15 2c 0c 00 00    	mov    %edx,0xc2c
}
 798:	5e                   	pop    %esi
 799:	5f                   	pop    %edi
 79a:	5d                   	pop    %ebp
 ...
 7c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7cc:	89 15 2c 0c 00 00    	mov    %edx,0xc2c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ec:	8b 3d 2c 0c 00 00    	mov    0xc2c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 82f:	73 4f                	jae    880 <malloc+0xa0>
    ...
    if(p == freep)
 831:	8b 3d 2c 0c 00 00    	mov    0xc2c,%edi
 ...
 85a:	e8 f1 fe ff ff       	call   750 <free>
  return freep;
 85f:	8b 15 2c 0c 00 00    	mov    0xc2c,%edx
 ...
 8a7:	0c 00 00 
    base.s.size = 0;
 8aa:	bf 30 0c 00 00       	mov    $0xc30,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 8b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8bb:	c7 05 34 0c 00 00 00 	movl   $0x0,0xc34
 8c2:	00 00 00 
    if(p->s.size >= nunits){
