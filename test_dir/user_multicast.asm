...
_user_multicast:     file format elf32-i386
...
int main(void)
{
  ...
  15:	51                   	push   %ecx
  16:	83 ec 54             	sub    $0x54,%esp
    printf(1, "IPC Test case\n");
  19:	68 a8 08 00 00       	push   $0x8a8
  1e:	6a 01                	push   $0x1
  20:	e8 5b 05 00 00       	call   580 <printf>
    //int cid1=-1, cid2=-1, cid3=-1, cid4=-1;
    int cid[CHILDNUM]={-1, -1, -1, -1, -1, -1, -1, -1};
  25:	c7 45 c8 ff ff ff ff 	movl   $0xffffffff,-0x38(%ebp)
  2c:	83 c4 10             	add    $0x10,%esp
  2f:	c7 45 cc ff ff ff ff 	movl   $0xffffffff,-0x34(%ebp)
  36:	c7 45 d0 ff ff ff ff 	movl   $0xffffffff,-0x30(%ebp)
  3d:	c7 45 d4 ff ff ff ff 	movl   $0xffffffff,-0x2c(%ebp)
  44:	c7 45 d8 ff ff ff ff 	movl   $0xffffffff,-0x28(%ebp)
  4b:	c7 45 dc ff ff ff ff 	movl   $0xffffffff,-0x24(%ebp)
  52:	c7 45 e0 ff ff ff ff 	movl   $0xffffffff,-0x20(%ebp)
  59:	c7 45 e4 ff ff ff ff 	movl   $0xffffffff,-0x1c(%ebp)
    for(int i=0; i<8; i++){
        cid[i]=fork();
  60:	e8 66 03 00 00       	call   3cb <fork>
  65:	89 06                	mov    %eax,(%esi)
        if(cid[i]==0)break;
  67:	85 c0                	test   %eax,%eax
  69:	74 07                	je     72 <main+0x72>
    for(int i=0; i<8; i++){
  6b:	83 c6 04             	add    $0x4,%esi
  6e:	39 de                	cmp    %ebx,%esi
  70:	75 ee                	jne    60 <main+0x60>
    }
    
    if ( cid[0] == 0 || cid[1] == 0 || cid[2] == 0 || cid[3] == 0 || cid[4] == 0 || cid[5] == 0 ||cid[6] == 0 ||cid[7] == 0 ) {
  72:	8b 5d c8             	mov    -0x38(%ebp),%ebx
  75:	85 db                	test   %ebx,%ebx
  77:	74 07                	je     80 <main+0x80>
  79:	8b 4d cc             	mov    -0x34(%ebp),%ecx
  7c:	85 c9                	test   %ecx,%ecx
  7e:	75 45                	jne    c5 <main+0xc5>
        // This is child
        float* msg=malloc(2*sizeof(int));
  80:	83 ec 0c             	sub    $0xc,%esp
  83:	6a 08                	push   $0x8
  85:	e8 26 07 00 00       	call   7b0 <malloc>
  8a:	89 c3                	mov    %eax,%ebx
        recv(msg);
  8c:	89 04 24             	mov    %eax,(%esp)
  8f:	e8 07 04 00 00       	call   49b <recv>
        float fnew=*msg;
        printf(1, "CHILD: received message: %d\n", (int)fnew);
  94:	d9 03                	flds   (%ebx)
  96:	83 c4 0c             	add    $0xc,%esp
  99:	d9 7d b6             	fnstcw -0x4a(%ebp)
  9c:	0f b7 45 b6          	movzwl -0x4a(%ebp),%eax
  a0:	80 cc 0c             	or     $0xc,%ah
  a3:	66 89 45 b4          	mov    %ax,-0x4c(%ebp)
  a7:	d9 6d b4             	fldcw  -0x4c(%ebp)
  aa:	db 5d b0             	fistpl -0x50(%ebp)
  ad:	d9 6d b6             	fldcw  -0x4a(%ebp)
  b0:	8b 45 b0             	mov    -0x50(%ebp),%eax
  b3:	50                   	push   %eax
  b4:	68 b7 08 00 00       	push   $0x8b7
  b9:	6a 01                	push   $0x1
  bb:	e8 c0 04 00 00       	call   580 <printf>
        exit();
  c0:	e8 0e 03 00 00       	call   3d3 <exit>
    if ( cid[0] == 0 || cid[1] == 0 || cid[2] == 0 || cid[3] == 0 || cid[4] == 0 || cid[5] == 0 ||cid[6] == 0 ||cid[7] == 0 ) {
  c5:	83 7d d0 00          	cmpl   $0x0,-0x30(%ebp)
  c9:	74 b5                	je     80 <main+0x80>
  cb:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
  cf:	74 af                	je     80 <main+0x80>
  d1:	83 7d d8 00          	cmpl   $0x0,-0x28(%ebp)
  d5:	74 a9                	je     80 <main+0x80>
  d7:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
  db:	74 a3                	je     80 <main+0x80>
  dd:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  e1:	74 9d                	je     80 <main+0x80>
  e3:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  e7:	74 97                	je     80 <main+0x80>
    } else {
        // This is parent
        ps();
  e9:	e8 9d 03 00 00       	call   48b <ps>
        //int a =1;
        //char* a = "Hello child!";
        float f=3.3;
        float* a= &f;
  ee:	8d 5d c0             	lea    -0x40(%ebp),%ebx
        float f=3.3;
  f1:	c7 45 c0 33 33 53 40 	movl   $0x40533333,-0x40(%ebp)
        float* a= &f;
  f8:	89 5d c4             	mov    %ebx,-0x3c(%ebp)
        //int recids[8]={cid1, cid2, cid3, cid4, -1, -1, -1, -1};
        send_multi(getpid(), cid, a);
  fb:	e8 53 03 00 00       	call   453 <getpid>
 100:	52                   	push   %edx
 101:	8d 55 c8             	lea    -0x38(%ebp),%edx
 104:	53                   	push   %ebx
 105:	52                   	push   %edx
 106:	50                   	push   %eax
 107:	e8 97 03 00 00       	call   4a3 <send_multi>
        printf(1, "PARENT: sent message: %d", (int)f);
 10c:	d9 45 c0             	flds   -0x40(%ebp)
 10f:	83 c4 0c             	add    $0xc,%esp
 112:	d9 7d b6             	fnstcw -0x4a(%ebp)
 115:	0f b7 45 b6          	movzwl -0x4a(%ebp),%eax
 119:	80 cc 0c             	or     $0xc,%ah
 11c:	66 89 45 b4          	mov    %ax,-0x4c(%ebp)
 120:	d9 6d b4             	fldcw  -0x4c(%ebp)
 123:	db 5d b0             	fistpl -0x50(%ebp)
 126:	d9 6d b6             	fldcw  -0x4a(%ebp)
 129:	8b 45 b0             	mov    -0x50(%ebp),%eax
 12c:	50                   	push   %eax
 12d:	68 d4 08 00 00       	push   $0x8d4
 132:	6a 01                	push   $0x1
 134:	e8 47 04 00 00       	call   580 <printf>
        free(&a);
 139:	8d 45 c4             	lea    -0x3c(%ebp),%eax
 13c:	89 04 24             	mov    %eax,(%esp)
 13f:	e8 dc 05 00 00       	call   720 <free>
        for(int i=0; i<8; i++)wait();
 144:	e8 92 02 00 00       	call   3db <wait>
 149:	e8 8d 02 00 00       	call   3db <wait>
 14e:	e8 88 02 00 00       	call   3db <wait>
 153:	e8 83 02 00 00       	call   3db <wait>
 158:	e8 7e 02 00 00       	call   3db <wait>
 15d:	e8 79 02 00 00       	call   3db <wait>
 162:	e8 74 02 00 00       	call   3db <wait>
 167:	e8 6f 02 00 00       	call   3db <wait>
    }
 ...
 4dc:	89 d1                	mov    %edx,%ecx
{
 ...
 509:	0f b6 92 4c 09 00 00 	movzbl 0x94c(%edx),%edx
 ...
 589:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5f9:	ff 24 85 f4 08 00 00 	jmp    *0x8f4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 707:	90                   	nop
          s = "(null)";
 708:	ba ed 08 00 00       	mov    $0x8ed,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 721:	a1 fc 0b 00 00       	mov    0xbfc,%eax
{
 ...
 761:	5b                   	pop    %ebx
  freep = p;
 762:	89 15 fc 0b 00 00    	mov    %edx,0xbfc
}
 768:	5e                   	pop    %esi
 769:	5f                   	pop    %edi
 76a:	5d                   	pop    %ebp
 ...
 799:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 79c:	89 15 fc 0b 00 00    	mov    %edx,0xbfc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7bc:	8b 3d fc 0b 00 00    	mov    0xbfc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ff:	73 4f                	jae    850 <malloc+0xa0>
    ...
    if(p == freep)
 801:	8b 3d fc 0b 00 00    	mov    0xbfc,%edi
 ...
 82a:	e8 f1 fe ff ff       	call   720 <free>
  return freep;
 82f:	8b 15 fc 0b 00 00    	mov    0xbfc,%edx
 ...
 85c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 85f:	89 15 fc 0b 00 00    	mov    %edx,0xbfc
}
 ...
 86f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 870:	c7 05 fc 0b 00 00 00 	movl   $0xc00,0xbfc
 877:	0c 00 00 
    base.s.size = 0;
 87a:	bf 00 0c 00 00       	mov    $0xc00,%edi
    base.s.ptr = freep = prevp = &base;
 87f:	c7 05 00 0c 00 00 00 	movl   $0xc00,0xc00
 886:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
